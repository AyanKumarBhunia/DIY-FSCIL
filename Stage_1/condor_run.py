...
with condor(
    ...
    run_file = os.path.join(os.getcwd(), "main.py")
    exp_name = "multi_modal_classification"
    ...
    for bs in ["_"]:  # submit a bunch of jobs
        ...
        j = Job(
            "/vol/research/ayanCV/anaconda3/envs/ayanPY/bin/python",  # if docker, use absolute path to specify executables inside container
            run_file,
