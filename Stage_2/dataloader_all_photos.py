...
class FewShotDataloader:
    ...
    def sample_episode(self):
        ...
        """
        support: exemplars, exemplars_labels: photos
        ...
        if self.is_eval_mode:
            ...
            for Knovel_idx in range(len(Knovel)):
                ...
                imd_ids = random.sample(
                    self.dataset.photo_data_dict[Knovel[Knovel_idx]], sample_size
                )
                ...
                Exemplars += [
                    (img_id, nKbase + Knovel_idx) for img_id in imds_ememplars
                ]
    ...
    def get_iterator(self, epoch=0):
        ...
        def load_function(iter_idx):
            ...
            for photo_path, _ in Exemplars:
                ...
                photo_img = self.dataset.input_transform(img)
                Xe.append(photo_img)
